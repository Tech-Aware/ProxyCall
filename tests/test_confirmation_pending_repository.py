...
class ConfirmationPendingRepositoryTests(unittest.TestCase):
    def test_find_pending_normalizes_numbers_with_channel_prefix(self):
        headers = [
            "pending_id",
            "client_name",
            "client_mail",
        ...
        records = [
            {
                ...
                "client_name": "",
                "client_mail": "",
                "client_real_phone": "+33 6 00 00 00 00",
                "proxy_number": "+33 9 12 34 56 78",
                "otp": "123456",
                "status": "PENDING",
                "created_at": "",
                "verified_at": "",
        ...
        rows = {1: headers, 2: ["abc", "", "", "+33 6 00 00 00 00", "+33 9 12 34 56 78", "123456", "PENDING", "", ""]}
        ...
        with patch(
            ...
            pending = ConfirmationPendingRepository.find_pending_by_proxy_and_phone(
                proxy_number="whatsapp:+33912345678",
                client_phone="sms:+33600000000",
            )
